...
BOT_TOKEN = environ.get('BOT_TOKEN', "7728454503:AAGBwOe1hpJLcn5fIzo9j1HSCiVAAmscW0s")


# This Pictures Is For Start Message Picture, You Can Add Multiple By Giving One Space Between Each.
PICS = (environ.get('PICS', 'https://envs.sh/OXW.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '523168225').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002355618880'))
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+-TasIeJTBa5iOGRl')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Niramovies_LinkZz')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'rolexmoviediscussion') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Naveenvnb')
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/niratutorial/5') # How Open Shortner Link Video Link , Channel Link Where You Upload Your Video.
